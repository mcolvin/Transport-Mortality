...
outcomes$d<- paste(outcomes$density, outcomes$outplantLocation, 
...
outcomes$ntranslocated_b<- cut(outcomes$ntranslocated,
    seq(0,90,by=10),include.lowest=TRUE)
outcomes$survivors_b<- cut(outcomes$survivors,
    seq(0,90,by=10),include.lowest=TRUE)
 
R<- dcast(outcomes, d~ntranslocated_b,
    value.var='U', mean)
...
w<- xtabs(~ ntranslocated_b + survivors_b + d, outcomes)

w<- prop.table(w,c(1,3))
