...
outcomes<- read.csv("./output/outcomes.csv")# results of line 33
```
...
mx<-max(outcomes$survivors)
mn<- min(outcomes$survivors)
...
d<- unique(outcomes$d)
W<- 0.7
outcomes$U<- W*outcomes$survivors_sc+(1-W)*outcomes$effort_sc

## SET DENSITIES GREATER THAN THE FISH NUMBER TO 0
outcomes$U<-ifelse(outcomes$density>outcomes$ntranslocated/outcomes$truckVolume,0,outcomes$U)
